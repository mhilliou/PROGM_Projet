    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            const Center(child: Text('Mode Solo', style: TextStyle(fontFamily: 'Signatra', fontSize: 70, color: Colors.white),)),
            const SizedBox(height: 30),
            const Text('Bienvenue dans le mode solo !', textAlign: TextAlign.center, style: TextStyle(fontSize: 20, color: Colors.white)),
